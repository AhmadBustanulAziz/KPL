...
class PendaftaranController extends BaseController {
	...
	public function store() {
			...
			return redirect()->back();
                        ...
                        $file_surat_berita = $this->request->getFile("surat_pemberitahuan");
                        $file_name_srt_berita = $file_surat_berita->getName();
                        $file_sk_kemenkumham = $this->request->getFile("sk_kemenkumham");
                        $file_name_sk_kmnkmhm = $file_sk_kemenkumham->getName();
                        $file_sk_kepengurusan = $this->request->getFile("sk_kepengurusan");
                        $file_name_sk_kpngrsn = $file_sk_kepengurusan->getName();
                        ...
                        $file_name_prog_kerja = $file_program_kerja->getName();
                        ...
                        $file_srt_keterangan = $this->request->getFile("surat_keterangan");
                        $file_name_srt_ktrngn = $file_srt_keterangan->getName();
                ...
                $syarat = [
                        "nama_organisasi" => $this->request->getVar("nama_organisasi"),
                        "surat_pemberitahuan" => $file_name_srt_berita,
                        "sk_kemenkumham" => $file_name_sk_kmnkmhm,
                        "sk_kepengurusan" => $file_name_sk_kpngrsn,
                        "akte" => $file_name_akte,
                        "ad_art" => $file_name_ad_art,
                        "program_kerja" => $file_name_prog_kerja,
                        "biodata" => $file_name_biodata,
                        "ktp" => $file_name_ktp,
                        "formulir" => $file_name_formulir,
                        "surat_keterangan" => $file_name_srt_ktrngn,
                        "npwp" => $file_name_npwp,
                        "foto" => $file_name_foto,
                        "keabsahan" => $file_name_keabsahan
                        ];
        
                        $file_surat_berita->move('document/pendaftaran/' . 
                        $this->request->getVar("nama_organisasi"), "Surat Pemberitahuan - " . $file_name_srt_berita);
                
                        $file_sk_kemenkumham->move('document/pendaftaran/' . 
                        $this->request->getVar("nama_organisasi"), "SK Kemenkumham - " . $file_name_sk_kmnkmhm);
                
                        $file_sk_kepengurusan->move('document/pendaftaran/' . 
                        $this->request->getVar("nama_organisasi"), "SK Kepengurusan - " . $file_name_sk_kpngrsn);
                        ...
                        $this->request->getVar("nama_organisasi"), "Program Kerja - " . $file_name_prog_kerja);
                        ...
                        $file_srt_keterangan->move('document/pendaftaran/' . 
                        $this->request->getVar("nama_organisasi"), "Surat Keterangan - " . $file_name_srt_ktrngn);
